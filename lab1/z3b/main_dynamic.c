...
int main(int argc,char **argv){
    ...
    if(!handle){
        printf("Opening library went wrong.");
        return 0;
    }
    if(argc < 2)
    {
    ...
    BlocksArray* (*createArrayOfBlocks)() = (BlocksArray* (*)()) dlsym(handle,"createArrayOfBlocks");
    int (*removeBlock)() = (int (*)()) dlsym(handle,"removeBlock");
    void (*removeArrayOfBlocks)() = (void (*)()) dlsym(handle,"removeArrayOfBlocks");
    void (*printArrayOfBlocks)() = (void (*)()) dlsym(handle,"printArrayOfBlocks");
    int (*count)() = (int (*)()) dlsym(handle,"count");
    int (*is_number)() = (int (*)()) dlsym(handle,"is_number");
    void (*create_temp_file)() = (void (*)()) dlsym(handle,"create_temp_file");
    void (*delete_temp_file)() = (void (*)()) dlsym(handle,"delete_temp_file");

    raportFile = fopen("./results3b.txt","a");
